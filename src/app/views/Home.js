...
export default function Home() {
	...
	return (
		<Box sx={{ background: theme.palette.background.light_1 }}>
				...
				<Box className="z-2 container items-center flex flex-wrap" style={{ marginLeft: '100px' }}>
					...
					>
						...
						>
							...
							contemporary dance. It is the only school of its kind in northern Germany. The three years
							professional dance training focus on contemporary and modern dance techniques,
							improvisation, composition and on classical ballet. An experienced team of international
							dancers and instructors will help you achieve your goals and give you the skills needed for
							your professional career as a dancer and/or performer.
						</Typography>
						{/* <div className="mt-12">
                <a
			...
			<section className="pt-12 md:pt-40 pb-40 relative" style={{ background: theme.palette.background.light_2 }}>
				{/* <div
        ...
        >
          ...
          >
            <polygon
              ...
              style={{ color: theme.palette.background.light_2 }}
					...
					<div className="flex flex-wrap items-center">
						...
						<div className="w-full md:w-6/12 px-4">
							<div className="flex flex-wrap px-4">
								<Typography variant="h2" style={{ color: 'rgb(186 186 186)', paddingBottom: '16px' }}>
									WAS GIBTS NEUES?
								</Typography>
									...
									<div className="relative flex flex-col mt-4">
										...
										>
											...
											<Typography
												...
												className="myText truncate"
											>
												Jedes Jahr findet das Abschlussprojekt, die finale Prüfungsleistung
												unserer Absolvent*innen, unter einem anderen Thema statt. Raul Valdez,
				...
				<div className="justify-center text-center flex flex-wrap mt-24">
					<div className="w-full md:w-6/12 px-12 md:px-4">
						...
						<p className="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
							Notus React is a completly new product built using our past experience in web templates.
			...
			<section className="block relative z-1" style={{ background: theme.palette.background.default }}>
				<div className="container mx-auto">
			...
			<section className="py-20 overflow-hidden" style={{ background: theme.palette.background.default }}>
			...
			<section className="pb-16 relative pt-32" style={{ background: theme.palette.background.light_1 }}>
				<div
					className="-mt-20 top-0 bottom-auto left-0 right-0 w-full absolute h-20"
					style={{ transform: 'translateZ(0)' }}
				>
					...
					>
						<polygon
							className="fill-current"
							style={{ color: theme.palette.background.light_1 }}
							points="2560 0 2560 100 0 100"
						></polygon>
					</svg>
				</div>
